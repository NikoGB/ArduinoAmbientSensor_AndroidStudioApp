...
public class MainContentFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState ) {
        ...
        new TabLayoutMediator(tabLayout, mainViewPag, (tab, position) -> {
            tab.setText((position == 0 ? "General" : position == 1 ? "Data" : "Conexion"));
        }).attach();
    ...
    class FragmentAdapter extends FragmentStateAdapter {
        ...
        public Fragment createFragment(int position) {
            ...
            switch(position){
                ...
                case 1 :
                    if(ControlCenter.getInstance().dataFrag == null){ ControlCenter.getInstance().dataFrag = new DataFragment(); }
                    return ControlCenter.getInstance().dataFrag;
